// Colors
export const stylePrimaryColor = `#2c075a`;
export const styleWhiteColor = `white`;
export const styleErrorColor = '#FF4040';
export const styleAcceptColor = '#02752E';
export const styleFontWeightBold400 = '400';
export const styleFontWeightBold500 = '500';
...
export const styleStandardBackButtonHeight = 40;
